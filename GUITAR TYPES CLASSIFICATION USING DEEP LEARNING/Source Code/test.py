...
guitar_types = ['Acoustic Guitar', 'Bass Guitar', 'Electric Guitar']
song_samples = 600
...
def get_guitar_types(path, debug=False):
    model = load_model('./trained_model/GuitarClassifier.h5')
    ...
    return guitar_types[np.bincount(predictions).argmax()]

if __name__ == '__main__':
    print(get_guitar_types('./test_data/MyOwnGuitar.wav', True))
